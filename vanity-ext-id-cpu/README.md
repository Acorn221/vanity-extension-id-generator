# Chrome Extension Vanity ID Generator (CPU Version)
...
**Note:** This is the CPU-only version. For Apple Silicon GPU acceleration, see [vanity-ext-id-metal](../vanity-ext-id-metal/).
...
**Note:** The `wordlist.txt` file (~3600 words, filtered to ~1000 valid a-p) is located in the parent `vanity-ext-id/` directory.
